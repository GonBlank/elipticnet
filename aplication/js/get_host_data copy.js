...
function load_data(host) {
    ...
    edit_host.setAttribute('href', `host_edit.html?id=${hostId}&ip=${host.ip}&name=${host.name}&description=${host.description}&email_transport=${host.transports['email']}&telegram_transport=${host.transports['telegram']}`);
