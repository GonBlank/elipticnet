...
<link rel="stylesheet" href="../css/components/lateral_menu.css" />
...
<aside id="lateral_menu" class="lateral-menu collapsed">
    ...
    <div class="user-options">
        ...
        <button data-modal="dialogLogout" class="openModal logout">
...
<dialog id="dialogLogout">
    <div class="dialog-header">
        <h1>Log out</h1>
        <button class="close-modal closeModal">
    ...
    <div class="dialog-options">
        <button class="closeModal cancelModalBtn">Cancel</button>
        <a href="../php/sesion/logout.php" id="logoutBtn">
            <div class="text show">
                Logout
            </div>
...
<script src="../js/components/lateral_menu.js"></script>