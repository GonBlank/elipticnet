...
<body>
    ...
    <main class="dashboard">
        ...
        <section class="form-container card">
                ...
                <div class="input-row-group">
                    ...
                    <label class="label">
                        ...
                        <span class="label__name">
                            ...
                            IP</span>
                        <div class="error-message" id="hostIp-error"></div>
                    </label>
                </div>

                <label class="label">
                    <textarea maxlength="200" tabindex="3" type="text" placeholder=" " class="input textarea"
                        id="hostDescription" name="hostDescription" autocomplete="description" required></textarea>
                    <span class="label__name textarea">
                        ...
                        Description</span>
                    <div class="error-message" id="hostDescription-error"></div>
                </label>
            ...
            <div class="additional_checks">
                ...
                <span class="tooltip">
                    <div id="thresholdBox" class="threshold init">
                        ...
                        <label class="label" id="thresholdInputWrapper" style="display: none;">
            ...
            <section id="alertTransportsTable" class="alert-transports">
