...
<head>
    ...
    <title>Elipticnet || Transports</title>
...
<body>
    ...
    <nav>
        ...
        <h1 id="nav-tittle"> Transports</h1>
    ...
    <main class="dashboard">
        <section class="form-container">
            ...
            <p class="subtittle">
                The emails listed here will be available to be selected as recipients of notices on the monitors.
            </p>

            <div id="emailTransportTable" class="table">
                <!--
                <div class="row">
                    <div class="transport_alias validated">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <h1 class="transport_id"> test@gmail.com</h1>
                    <div class="transport_options">
                        ...
                        <button class="delete openModal" data-modal="delete_transport" data-id="${data.id}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="row">
                    <div class="transport_alias no_validated">
                        <span class="tooltip">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <h1 class="transport_id"> test1@gmail.com</h1>
                    <div class="transport_options">
                        <span class="tooltip">
                            <button class="resend">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <span class="tooltip-text">Resend validation code</span>
                        </span>
                        <button class="edit">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-pencil-square" viewBox="0 0 16 16">
                        ...
                        <button class="delete openModal" data-modal="delete_transport">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-trash" viewBox="0 0 16 16">
                                <path
                                    d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z" />
        ...
        <section class="form-container">
            ...
            <p class="subtittle">
                The Telegram IDs listed here will be available to be selected as recipients of notices on the
                monitors.<br>
                Please ensure you add the bot to your Telegram account to receive the validation code correctly.
                <a href="https://t.me/elipticnet_bot" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-plus" viewBox="0 0 16 16">
                        <path
                            d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
    ...
    <dialog id="add_email">
        ...
        <div class="dialog-body">
            <form>
                <label class="label">
                    <input tabindex="1" type="text" placeholder=" " class="input" id="email_alias" name="email_alias"
                        autocomplete="name" maxlength="15" required />
                    <span class="label__name">
                        ...
                        Alias</span>
                    <div class="error-message" id="email_alias-error"></div>
                </label>
                <label class="label" for="transport-email">
                    <input tabindex="1" type="email" placeholder=" " class="input" id="transport-email"
                        name="transport-email" autocomplete="email" required />
                    <span class="label__name">
    ...
    <dialog id="delete_transport">
        ...
        <div class="dialog-body">
            <p>The transport will stop receiving all alerts.</p>
        </div>
