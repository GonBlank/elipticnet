...
<body>
    ...
    <nav>
        ...
        <h1 id="nav-tittle"> User config</h1>
    ...
    <main class="dashboard">
            ...
            <div class="input-form">
                <label class="label" for="actual-password">
                    ...
                    <span class="label__name">
                        ...
                        Actual password</span>
                    <div class="error-message" id="actual-password-error"></div>
                </label>

                <label class="label" for="new-password">
                    <input type="password" placeholder=" " class="input" id="new-password"
                        name="new-password" autocomplete="password" required minlength="8"
                        maxlength="20" />
                    <span class="label__name">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                            fill="#e8eaed">
        ...
        <section class="form-container">
            <div class="tittle">
                <h1>
                    <svg style="fill: #f83b3b" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#f83b3b"
