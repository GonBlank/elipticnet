    ...
    <main class="dashboard">
        <section class="form-container card">
            ...
            <div class="additional_checks">
                ...
                <span class="tooltip">
                    <div class="threshold init">
                        <div class="checkbox-wrapper-13">
                            <input id="ttfbThresholdCheckbox" class="threshold-checkbox" type="checkbox">
                            <label for="ttfbThresholdCheckbox">TTFB Threshold</label>
                        </div>
                        <label class="label threshold-input-wrapper" style="display: none;">
                            <input id="ttfbThresholdValue" tabindex="1" type="number" placeholder=" " class="input" name="threshold"
                                autocomplete="name" max="999" />
                            <span class="label__name">100ms</span>
                            <div id="ttfbThresholdValueError" class="error-message"></div>
                        </label>
                    </div>
                    <span class="tooltip-text">
                        If the time to the first bit is higher than the threshold we will send a warning.<br> - Value [ms]
                    </span>
                </span>
                ...
                <span class="tooltip">
                    <div class="threshold init">
                        <div class="checkbox-wrapper-13">
                            <input id="responseTimeThresholdCheckbox" class="threshold-checkbox" type="checkbox">
                            <label for="responseTimeThresholdCheckbox">Response time Threshold</label>
                        </div>
                        <label class="label threshold-input-wrapper" style="display: none;">
                            <input id="responseTimeThresholdValue" tabindex="2" type="number" placeholder=" " class="input" name="threshold"
                                autocomplete="name" max="999" />
                            <span class="label__name">100ms</span>
                            <div id="responseTimeThresholdValueError" class="error-message"></div>
                        </label>
                    </div>
                    <span class="tooltip-text">
                        If the time to the first bit is higher than the threshold we will send a warning.<br> - Value [ms]
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        document.querySelectorAll(".threshold-checkbox").forEach(checkbox => {
                            checkbox.addEventListener("change", function() {
                                const thresholdBox = this.closest(".threshold");
                                const inputWrapper = thresholdBox.querySelector(".threshold-input-wrapper");
