...
CREATE TABLE ping_agent_data (
    ...
    threshold_time DATETIME DEFAULT NULL, -- Revisar. me parece que no lo uso nunca
...
CREATE TABLE web_agent_data (
    ...
    response_time_threshold_exceeded BOOLEAN DEFAULT NULL, 
    ttfb FLOAT DEFAULT NULL,
    ttfb_threshold FLOAT DEFAULT NULL, 
    ttfb_threshold_exceeded BOOLEAN DEFAULT NULL,
    redirects JSON,
